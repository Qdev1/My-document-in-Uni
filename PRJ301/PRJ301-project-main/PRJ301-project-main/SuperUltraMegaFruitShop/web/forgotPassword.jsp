<%-- 
    ...
    Created on : Jun 29, 2022, 1:22:33 AM
    Author     : Nezio
--%>
    ...
    <body>
        <div class="container-login100" style="background-image: url(&#39;img/login_bg_img.jpg&#39;);">
            <div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
                <form class="login100-form validate-form" method ="post" action="forgotController">
                    ...
                    <div class="container-login100-form-btn">
                        <input type="submit" value="RESET" name="reset" class="login100-form-btn">
                    </div>
                    <br>
